...
<img src="{{ site.url }}{{ site.baseurl }}/images/cavs/Python_logo.ico" alt="cat" >
...
* Icone oficial do CAVS - adsorption evaluation *
{: .text-center}
<img src="{{ site.url }}{{ site.baseurl }}/images/cavs/favicon.ico" alt="cat" >
